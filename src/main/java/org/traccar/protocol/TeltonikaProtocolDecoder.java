...
public class TeltonikaProtocolDecoder extends BaseProtocolDecoder {
    ...
    static {
        ...
        // CAN I/O standard elements
        // specific FMB150
        register(115, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_COOLANT_TEMP, b.readShort() * 0.1));
        register(85, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_SPEED, b.readUnsignedShort()));
        register(8, fmbXXX, (p, b) -> p.set(Position.KEY_AUTHORIZED_IBUTTON, ByteBufUtil.hexDump(b.readSlice(8))));
        register(81, fmbXXX, (p, b) -> p.set(Position.KEY_VEHICLE_SPEED, b.readUnsignedByte()));
        register(82, fmbXXX, (p, b) -> p.set(Position.KEY_THROTTLE_POSITION, b.readUnsignedByte()));
        register(89, fmbXXX, (p, b) -> p.set(Position.KEY_FUEL_LEVEL_PERCENT, b.readUnsignedShort()));
        register(87, fmbXXX, (p, b) -> p.set(Position.KEY_TOTAL_MILEAGE, b.readUnsignedInt()));
        register(84, fmbXXX, (p, b) -> p.set(Position.KEY_FUEL_LEVEL_LITERS, b.readUnsignedShort() * 0.1));
        register(400, fmbXXX, (p, b) -> p.set(Position.KEY_DISTANCE_TO_SERVICE, b.readUnsignedInt()));
        register(866, fmbXXX, (p, b) -> p.set(Position.KEY_REMAINING_DISTANCE, b.readUnsignedInt()));
        register(940, fmbXXX, (p, b) -> p.set(Position.KEY_SEAT_BELT_FL, b.readUnsignedByte()));
        register(941, fmbXXX, (p, b) -> p.set(Position.KEY_SEAT_BELT_FR, b.readUnsignedByte()));
        register(942, fmbXXX, (p, b) -> p.set(Position.KEY_SEAT_BELT_RL, b.readUnsignedByte()));
        register(943, fmbXXX, (p, b) -> p.set(Position.KEY_SEAT_BELT_RR, b.readUnsignedByte()));
        register(654, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR_FL, b.readUnsignedByte()));
        register(655, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR_FR, b.readUnsignedByte()));
        register(269, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_TEMP1, b.readShort()));
        register(271, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_BATTERY1, b.readUnsignedShort() * 0.01));
        register(272, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_TEMP2, b.readShort()));
        register(274, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_BATTERY2, b.readUnsignedShort() * 0.01));
        register(275, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_TEMP3, b.readShort()));
        register(277, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_BATTERY3, b.readUnsignedShort() * 0.01));
        register(278, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_TEMP4, b.readShort()));
        register(280, fmbXXX, (p, b) -> p.set(Position.KEY_ESCORT_BATTERY4, b.readUnsignedShort() * 0.01));
        register(656, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR_RL, b.readUnsignedByte()));
        register(657, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR_RR, b.readUnsignedByte()));
        register(913, fmbXXX, (p, b) -> p.set(Position.KEY_BONNET, b.readUnsignedByte()));
        register(658, fmbXXX, (p, b) -> p.set(Position.KEY_TRUNK, b.readUnsignedByte()));
        register(152, fmbXXX, (p, b) -> p.set(Position.KEY_HV_BATTERY_LEVEL, b.readUnsignedByte()));
        register(937, fmbXXX, (p, b) -> p.set(Position.KEY_CRUISE_CONTROL, b.readUnsignedByte()));
        register(910, fmbXXX, (p, b) -> p.set(Position.KEY_BRAKE_SWITCH, b.readUnsignedByte()));
        register(928, fmbXXX, (p, b) -> p.set(Position.KEY_LAMP_SIDE, b.readUnsignedByte()));
        register(929, fmbXXX, (p, b) -> p.set(Position.KEY_LAMP_DIMMED, b.readUnsignedByte()));
        register(930, fmbXXX, (p, b) -> p.set(Position.KEY_LAMP_REFLECTOR, b.readUnsignedByte()));
        register(932, fmbXXX, (p, b) -> p.set(Position.KEY_LAMP_FOG_FRONT, b.readUnsignedByte()));
        register(931, fmbXXX, (p, b) -> p.set(Position.KEY_LAMP_FOG_REAR, b.readUnsignedByte()));
        register(653, fmbXXX, (p, b) -> p.set(Position.KEY_PARKING_BRAKE, b.readUnsignedByte()));
        register(911, fmbXXX, (p, b) -> p.set(Position.KEY_CLUTCH_SWITCH, b.readUnsignedByte()));
        register(168, fmbXXX, (p, b) -> p.set(Position.KEY_BATTERY_VOLTAGE, b.readUnsignedShort()));
        register(662, fmbXXX, (p, b) -> p.set(Position.KEY_CENTRAL_LOCK, b.readUnsignedByte()));
        register(944, fmbXXX, (p, b) -> p.set(Position.KEY_SEAT_BELT_RC, b.readUnsignedByte()));
        register(1112, fmbXXX, (p, b) -> p.set(Position.KEY_EV_HV_VOLTAGE, b.readUnsignedShort()));
        register(1113, fmbXXX, (p, b) -> p.set(Position.KEY_EV_HV_CURRENT, b.readUnsignedShort()));
        register(1157, fmbXXX, (p, b) -> p.set(Position.KEY_EV_HV_POWER, b.readUnsignedShort() * 0.1));
        register(105, fmbXXX, (p, b) -> p.set(Position.KEY_TOTAL_MILEAGE_COUNTED, b.readUnsignedInt()));
        register(107, fmbXXX, (p, b) -> p.set(Position.KEY_FUEL_CONSUMED_COUNTED, b.readUnsignedInt() * 0.1));
        register(1156, fmbXXX, (p, b) -> p.set(Position.KEY_HV_ENERGY_RECUP, b.readUnsignedInt() * 0.01));
        register(1155, fmbXXX, (p, b) -> p.set(Position.KEY_HV_ENERGY_CONSUMED, b.readUnsignedInt() * 0.01));
        register(83, fmbXXX, (p, b) -> p.set(Position.KEY_FUEL_CONSUMPTION, b.readUnsignedInt() * 0.1));
        register(1413, fmbXXX, (p, b) -> p.set(Position.KEY_TURN_LEFT, b.readUnsignedByte()));
        register(1414, fmbXXX, (p, b) -> p.set(Position.KEY_TURN_RIGHT, b.readUnsignedByte()));
        register(325, fmbXXX, (p, b) -> p.set(Position.KEY_VIN, b.readCharSequence(17, StandardCharsets.US_ASCII).toString()));
        register(1418, fmbXXX, (p, b) -> p.set(Position.KEY_MOTOR_TEMP, b.readShort()));
        register(1415, fmbXXX, (p, b) -> p.set(Position.KEY_CHARGE_FLAP, b.readUnsignedByte()));
        register(914, fmbXXX, (p, b) -> p.set(Position.KEY_CHARGE_PLUG, b.readUnsignedByte()));
        register(915, fmbXXX, (p, b) -> p.set(Position.KEY_HV_CHARGING_STATE, b.readUnsignedByte()));
        // CAN I/O extended elements
        register(660, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_LEVER_P, b.readUnsignedByte()));
        register(661, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_LEVER_R, b.readUnsignedByte()));
        register(659, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_LEVER_N, b.readUnsignedByte()));
        register(927, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_LEVER_D, b.readUnsignedByte()));
        register(1158, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_OIL_PRESSURE, b.readUnsignedShort()));
        register(1159, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_OIL_LEVEL, b.readUnsignedByte()));
        register(1137, fmbXXX, (p, b) -> p.set(Position.KEY_STEERING_ANGLE, b.readShort() * 0.1));
        register(1358, fmbXXX, (p, b) -> p.set(Position.KEY_STEERING_LEFT, b.readUnsignedByte()));
        register(1359, fmbXXX, (p, b) -> p.set(Position.KEY_STEERING_RIGHT, b.readUnsignedByte()));
        register(1360, fmbXXX, (p, b) -> p.set(Position.KEY_ECO_SWITCH, b.readUnsignedByte()));
        register(1362, fmbXXX, (p, b) -> p.set(Position.KEY_ALL_DOORS, b.readUnsignedByte()));
        register(1331, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_SELECTED_GEAR, b.readShort()));
        register(1332, fmbXXX, (p, b) -> p.set(Position.KEY_TRANS_CURRENT_GEAR, b.readShort()));
        register(1333, fmbXXX, (p, b) -> p.set(Position.KEY_STEERING_TURN_COUNT, b.readUnsignedByte()));
        register(1361, fmbXXX, (p, b) -> p.set(Position.KEY_RAMP_STATUS, b.readUnsignedByte()));
        register(1335, fmbXXX, (p, b) -> p.set(Position.KEY_ADBLUE_LEVEL, b.readUnsignedByte()));
        register(1336, fmbXXX, (p, b) -> p.set(Position.KEY_BELLOW_PRESSURE_FR, b.readUnsignedShort() * 0.1));
        register(1337, fmbXXX, (p, b) -> p.set(Position.KEY_BELLOW_PRESSURE_FL, b.readUnsignedShort() * 0.1));
        register(1338, fmbXXX, (p, b) -> p.set(Position.KEY_BELLOW_PRESSURE_RR, b.readUnsignedShort() * 0.1));
        register(1339, fmbXXX, (p, b) -> p.set(Position.KEY_BELLOW_PRESSURE_RL, b.readUnsignedShort() * 0.1));
        register(1364, fmbXXX, (p, b) -> p.set(Position.KEY_OVERSPEED, b.readUnsignedByte()));
        register(1220, fmbXXX, (p, b) -> p.set(Position.KEY_GROSS_COMB_WEIGHT, b.readUnsignedShort() * 10));
        register(1341, fmbXXX, (p, b) -> p.set(Position.KEY_GASEOUS_FUEL_RATE, b.readUnsignedShort() * 0.1));
        register(1366, fmbXXX, (p, b) -> p.set(Position.KEY_ALTERNATOR_1, b.readUnsignedByte()));
        register(1367, fmbXXX, (p, b) -> p.set(Position.KEY_ALTERNATOR_2, b.readUnsignedByte()));
        register(1368, fmbXXX, (p, b) -> p.set(Position.KEY_ALTERNATOR_3, b.readUnsignedByte()));
        register(1369, fmbXXX, (p, b) -> p.set(Position.KEY_ALTERNATOR_4, b.readUnsignedByte()));
        register(102, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_TOTAL_HOURS, b.readUnsignedInt()));
        register(103, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_TOTAL_HOURS_COUNTED, b.readUnsignedInt()));
        register(118, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE1_LOAD, b.readUnsignedShort()));
        register(119, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE2_LOAD, b.readUnsignedShort()));
        register(120, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE3_LOAD, b.readUnsignedShort()));
        register(121, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE4_LOAD, b.readUnsignedShort()));
        register(122, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE5_LOAD, b.readUnsignedShort()));
        register(1342, fmbXXX, (p, b) -> p.set(Position.KEY_AXLE6_LOAD, b.readUnsignedShort()));
        register(1270, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_OIL_TEMP, b.readByte()));
        register(1343, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_FUEL_TEMP, b.readShort()));
        register(1344, fmbXXX, (p, b) -> p.set(Position.KEY_CRUISE_SET_SPEED, b.readUnsignedByte()));
        register(1345, fmbXXX, (p, b) -> p.set(Position.KEY_FUEL_ECONOMY, b.readUnsignedByte()));
        register(1352, fmbXXX, (p, b) -> p.set(Position.KEY_AIR_INTAKE_PRESSURE, b.readUnsignedShort()));
        register(1373, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR1_LOCK, b.readUnsignedByte()));
        register(1374, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR2_LOCK, b.readUnsignedByte()));
        register(1375, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR3_LOCK, b.readUnsignedByte()));
        register(1376, fmbXXX, (p, b) -> p.set(Position.KEY_DOOR4_LOCK, b.readUnsignedByte()));
        register(936, fmbXXX, (p, b) -> p.set(Position.KEY_AC_ON, b.readUnsignedByte()));
        register(956, fmbXXX, (p, b) -> p.set(Position.KEY_ESP, b.readUnsignedByte()));
        register(114, fmbXXX, (p, b) -> p.set(Position.KEY_ENGINE_TORQUE, b.readUnsignedByte()));
        register(1396, fmbXXX, (p, b) -> p.set(Position.KEY_AMBIENT_TEMP, b.readByte()));
        register(1397, fmbXXX, (p, b) -> p.set(Position.KEY_ASR, b.readUnsignedByte()));
        register(1416, fmbXXX, (p, b) -> p.set(Position.KEY_WIPER, b.readUnsignedByte()));
        register(946, fmbXXX, (p, b) -> p.set(Position.KEY_PTO, b.readUnsignedByte()));
        register(1116, fmbXXX, (p, b) -> p.set(Position.KEY_MAX_ROAD_SPEED, b.readUnsignedByte()));
        register(1117, fmbXXX, (p, b) -> p.set(Position.KEY_EXCEEDED_ROAD_SPEED, b.readUnsignedByte()));
        register(1205, fmbXXX, (p, b) -> p.set(Position.KEY_SPEED_SIGN_RECOGNIZED, b.readUnsignedByte()));
        register(1207, fmbXXX, (p, b) -> p.set(Position.KEY_SPEED_SIGN_EXCEEDED, b.readUnsignedByte()));
